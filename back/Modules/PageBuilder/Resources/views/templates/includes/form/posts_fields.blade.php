@if($row->widget_type == 'posts')
    <div class="row">
        ...
        {{-- featured_products_btn_color --}}
        <div class="mb-3 col-lg-3">
            <label class="form-label" for="featured_products_btn_color_hover">رنگ متن مشاهده همه (هاور)</label>
            <input id="featured_products_btn_color_hover{{$row->id}}" type="hidden" name="featured_products_btn_color_hover" class="form-control form-control-sm" value="{{old('featured_products_btn_color_hover',$row->featured_products_btn_color_hover)}}">
            <div class="color-picker-monolith" data-default-color="{{$row->featured_products_btn_color_hover}}" data-input-id="#featured_products_btn_color_hover{{$row->id}}"></div>
        </div>
        ...
        <div class="col-lg-3 mb-3">
            <label class="form-label">تعداد نمایش مقالات</label>
        ...
        <div class="col-12 mb-4">
            ...
            <small class="d-block text-muted mb-2">برای نمایش مقالات همه دسته‌بندی‌ها خالی بگذارید.</small>
